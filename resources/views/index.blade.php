...
@include('layouts.navbar')
        ...
        <main class="main">
            <div class="home-slider slide-animate owl-carousel owl-theme show-nav-hover nav-big mb-2 text-uppercase" data-owl-options="{
                ...
                <div class="home-slide home-slide1 banner">
                    ...
                    <div class="container d-flex align-items-center">
                        <div class="banner-layer appear-animate" data-animation-name="fadeInUpShorter">
                            ...
                            <h4 class="text-transform-none m-b-3 text-white">Une large sélection de produits au meilleur prix.</h4>
                    ...
                    <div class="container d-flex align-items-center">
                        <div class="banner-layer d-flex justify-content-center appear-animate" data-animation-name="fadeInUpShorter">
                            <div class="mx-auto">
                                ...
                                <h4 class="text-transform-none m-b-3 text-white">Un design élégant et des accessoires innovants pour la croissance.</h4>
                                <h5 class="d-inline-block mb-0">
                                </h5>
                                <a href="#" class="btn btn-primary btn-lg">Achetez maintenant</a>
                            </div>
                ...
                <!-- End .home-slide -->
                <div class="home-slide home-slide1 banner">
                    <img class="slide-bg" src="{{asset('assets/images/demoes/demo4/slider/slide-3.jpg')}}" width="1903" height="499" alt="slider image">
                    <div class="container d-flex align-items-center">
                        <div class="banner-layer appear-animate" data-animation-name="fadeInUpShorter">
                            <h3 class="m-b-3">Berceau Bébé <bR>Évolutif</h3>
                            <h4 class="text-transform-none m-b-3">Un beau lit à barreaux, pour accueillir le bébé dès les premières nuits.</h4>
                            <h5 class="d-inline-block mb-0">
                            </h5>
                            <a href="#" class="btn btn-primary btn-lg">Achetez maintenant</a>
                        </div>
                ...
                <!-- End .home-slide -->
                <div class="home-slide home-slide1 banner">
                    <img class="slide-bg" src="{{asset('assets/images/demoes/demo4/slider/slide-4.jpg')}}" width="1903" height="499" alt="slider image">
                    <div class="container d-flex align-items-center">
                        <div class="banner-layer appear-animate" data-animation-name="fadeInUpShorter">
                ...
                <div class="banners-container mb-2">
                    <div class="banners-slider owl-carousel owl-theme" data-owl-options="{
                        ...
                        <div class="banner banner1 banner-sm-vw d-flex align-items-center appear-animate" style="background-color: #ccc;" data-animation-name="fadeInLeftShorter" data-animation-delay="500">
                            <figure class="w-100">
                                <img src="{{asset('assets/images/demoes/demo4/banners/banner-1.png')}}" alt="banner" width="380" height="175" />
                            </figure>
                        ...
                        <div class="banner banner3 banner-sm-vw d-flex align-items-center appear-animate" style="background-color: #ccc;" data-animation-name="fadeInRightShorter" data-animation-delay="500">
                            <figure class="w-100">
                                <img src="{{asset('assets/images/demoes/demo4/banners/banner-3.png')}}" alt="banner" width="380" height="175" />
                            </figure>
                            <div class="banner-layer">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="product-default appear-animate mb-3" data-animation-name="fadeInRightShorter">
                                <figure>
                                    <a href="#">
                                        <img src="{{asset('assets/images/products/bp1.png')}}" width="280" height="280" alt="product">
                                        <img src="{{asset('assets/images/products/bp1.png')}}" width="280" height="280" alt="product">
                                    </a>
                                </figure>
                        ...
                        <div class="col-md-2">
                            <div class="product-default appear-animate mb-3" data-animation-name="fadeInRightShorter">
                                <figure>
                                    <a href="#">
                                        <img src="{{asset('assets/images/products/bp2.png')}}" width="280" height="280" alt="product">
                                        <img src="{{asset('assets/images/products/bp2.png')}}" width="280" height="280" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                        ...
                        <div class="col-md-2">
                            <div class="product-default appear-animate mb-3" data-animation-name="fadeInRightShorter">
                                <figure>
                                    <a href="#">
                                        <img src="{{asset('assets/images/products/bp3.png')}}" width="280" height="280" alt="product">
                                        <img src="{{asset('assets/images/products/bp3.png')}}" width="280" height="280" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                        ...
                        <div class="col-md-2">
                            <div class="product-default appear-animate mb-3" data-animation-name="fadeInRightShorter">
                                <figure>
                                    <a href="#">
                                        <img src="{{asset('assets/images/products/bp4.png')}}" width="280" height="280" alt="product">
                                        <img src="{{asset('assets/images/products/bp4.png')}}" width="280" height="280" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                        ...
                        <div class="col-md-2">
                            <div class="product-default appear-animate mb-3" data-animation-name="fadeInRightShorter">
                                <figure>
                                    <a href="#">
                                        <img src="{{asset('assets/images/products/bp6.png')}}" width="280" height="280" alt="product">
                                        <img src="{{asset('assets/images/products/bp6.png')}}" width="280" height="280" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                        ...
                        <div class="col-md-2">
                            <div class="product-default appear-animate mb-3" data-animation-name="fadeInRightShorter">
                                <figure>
                                    <a href="#">
                                        <img src="{{asset('assets/images/products/bp7.png')}}" width="280" height="280" alt="product">
                                        <img src="{{asset('assets/images/products/bp7.png')}}" width="280" height="280" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                        ...
                        <div class="col-md-12">
                            <div class="tabs mb-5">
                                ...
                                <ul class="nav nav-tabs justify-content-center" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="tab-popular8" data-toggle="tab" href="#popular-content8" role="tab" aria-controls="popular-content8" aria-selected="true"><i class="fa fa-star text-primary pr-2"></i>TRANSAT</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" id="recent-tab8" data-toggle="tab" href="#recent-content8" role="tab" aria-controls="recent-content8" aria-selected="true">PARAPHARMACIE</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="BIBERON-tab8" data-toggle="tab" href="#BIBERON-content8" role="tab" aria-controls="BIBERON-content8" aria-selected="true">BIBERON</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="LANGER-tab8" data-toggle="tab" href="#LANGER-content8" role="tab" aria-controls="LANGER-content8" aria-selected="true">SAC À LANGER</a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="popular-content8" role="tabpanel" aria-labelledby="tab-popular8">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="product-default appear-animate mb-3" data-animation-name="fadeInRightShorter">
                                                    <figure>
                                                        <a href="#">
                                                            <img src="{{asset('assets/images/products/c1.png')}}" width="280" height="280" alt="product">
                                                            <img src="{{asset('assets/images/products/c1.png')}}" width="280" height="280" alt="product">
                                                        </a>
                                                    </figure>
                                                    <div class="product-details">
                                            ...
                                            <div class="col-md-3">
                                                <div class="product-default appear-animate mb-3" data-animation-name="fadeInRightShorter">
                                                    <figure>
                                                        <a href="#">
                                                            <img src="{{asset('assets/images/products/c6.png')}}" width="280" height="280" alt="product">
                                                            <img src="{{asset('assets/images/products/c6.png')}}" width="280" height="280" alt="product">
                                                        </a>
                                                    </figure>
                                                    <div class="product-details">
                                            ...
                                            <div class="col-md-3">
                                                <div class="product-default appear-animate mb-3" data-animation-name="fadeInRightShorter">
                                                    <figure>
                                                        <a href="#">
                                                            <img src="{{asset('assets/images/products/c7.jpg')}}" width="280" height="280" alt="product">
                                                            <img src="{{asset('assets/images/products/c7.jpg')}}" width="280" height="280" alt="product">
                                                        </a>
                                                    </figure>
                                                    <div class="product-details">
                                            ...
                                            <div class="col-md-3">
                                                <div class="product-default appear-animate mb-3" data-animation-name="fadeInRightShorter">
                                                    <figure>
                                                        <a href="#">
                                                            <img src="{{asset('assets/images/products/c8.png')}}" width="280" height="280" alt="product">
                                                            <img src="{{asset('assets/images/products/c8.png')}}" width="280" height="280" alt="product">
                                                        </a>
                                                    </figure>
                                                    <div class="product-details">
                                    ...
                                    <div class="tab-pane fade" id="recent-content8" role="tabpanel" aria-labelledby="recent-tab8">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="product-default appear-animate mb-3" data-animation-name="fadeInRightShorter">
                                                    <figure>
                                    ...
                                    <div class="tab-pane fade" id="BIBERON-content8" role="tabpanel" aria-labelledby="BIBERON-tab8">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="product-default appear-animate mb-3" data-animation-name="fadeInRightShorter">
                                                    <figure>
                                    ...
                                    <div class="tab-pane fade" id="LANGER-content8" role="tabpanel" aria-labelledby="LANGER-tab8">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="product-default appear-animate mb-3" data-animation-name="fadeInRightShorter">
                                                    <figure>
            ...
            <div class="container">
                <div class="info-boxes-slider owl-carousel owl-theme mt-3 mb-2" data-owl-options="{
                    'dots': false,
                    'loop': false,
                    'responsive': {
                        '576': {
                ...
                <div class="container">
                    ...
                    <div class="categories-slider owl-carousel owl-theme show-nav-hover nav-outer">
                        <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                            <a href="#">
                                <figure>
                                    <img src="{{asset('assets/images/categories/bp1.png')}}" alt="category" width="280" height="240" />
                                </figure>
                        ...
                        <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                            <a href="#">
                                <figure>
                                    <img src="{{asset('assets/images/categories/bp2.png')}}" alt="category" width="220" height="220" />
                                </figure>
                                <div class="category-content">
                                    <h3>Vêtement</h3>
                                    <span><mark class="count">3</mark> products</span>
                        ...
                        <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                            <a href="#">
                                <figure>
                                    <img src="{{asset('assets/images/categories/bp3.png')}}" alt="category" width="220" height="220" />
                                </figure>
                                <div class="category-content">
                                    <h3>Chaussures</h3>
                                    <span><mark class="count">3</mark> products</span>
                        ...
                        <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                            <a href="#">
                                <figure>
                                    <img src="{{asset('assets/images/categories/bp4.png')}}" alt="category" width="220" height="220" />
                                </figure>
                                <div class="category-content">
                                    <h3>Repas Bébé</h3>
                                    <span><mark class="count">3</mark> products</span>
                        ...
                        <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                            <a href="#">
                                <figure>
                                    <img src="{{asset('assets/images/categories/bp5.png')}}" alt="category" width="220" height="220" />
                                </figure>
                                <div class="category-content">
                                    <h3>Jouet et Cadeaux</h3>
                                    <span><mark class="count">3</mark> products</span>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                            <a href="#">
                                <figure>
                                    <img src="{{asset('assets/images/categories/bp6.png')}}" alt="category" width="220" height="220" />
                                </figure>
                                <div class="category-content">
                                    <h3>Univers Maman</h3>
                                    <span><mark class="count">3</mark> products</span>
            ...
            <section class="testimonial-section testimonial-bg bg-gray">
                <div class="container">
                    <div class="owl-carousel owl-theme owl-dots-simple mb-4 mb-lg-0 appear-animate owl-loaded owl-drag animated fadeInRightShorter appear-animation-visible" data-owl-options="{
                'loop': false,
                'dots': false,
                'margin': 20,
                'responsive': null
                    ...
                    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 2400px;"><div class="owl-item active" style="width: 1180px; margin-right: 20px;"><div class="testimonial testimonial-type1 blockquote-both inner-blockquote owner-center">
                            <div class="testimonial-owner px-5">
                                <div class="text-center">
                                    <figure>
                                        <img src="{{asset('assets/images/elements/testimonial/client1.png')}}" width="62" height="62" alt="client">
                                    </figure>
                            ...
                            <div class="testimonial-owner px-5">
                                <div class="text-center">
                                    ...
                                    <blockquote class="text-gray">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec hendrerit
                                            vehicula est, in consequat. Lorem ipsum dolor sit amet, consectetur
                                            adipiscing elit. Donec hendrerit vehicula est, in consequat. Donec hendrerit
                                            vehicula est, in consequat. Donec hendrerit vehicula est, in consequat.</p>
                                    </blockquote>
            ...
            <section class="blog-section pb-0">
                <div class="container">
                    ...
                    <div class="owl-carousel owl-theme appear-animate" data-animation-name="fadeIn" data-owl-options="{
                        ...
                        <article class="post">
                            <div class="post-media">
                                <a href="#">
                                    <img src="{{asset('assets/images/blog/home/post1.png')}}" alt="Post" width="225" height="280">
                                </a>
                                <div class="post-date">
                            ...
                            <div class="post-body">
                                <h2 class="post-title">
                                    <a href="#">Soin et Bien être : comment bien choisir sa gamme de toilette pour bébé ?</a>
                                </h2>
                        ...
                        <article class="post">
                            ...
                            <div class="post-body">
                                <h2 class="post-title">
                                    <a href="#">La transition entre l’allaitement maternel et le biberon : le tire lait</a>
                                </h2>
                                <div class="post-content">
                                    <p>Leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of...</p>
                                </div>
                    ...
                    <div class="product-widgets-container row pb-2">
                        <div class="col-lg-3 col-sm-6 pb-5 pb-md-0 appear-animate animated fadeInLeftShorter appear-animation-visible" data-animation-name="fadeInLeftShorter" data-animation-delay="200" style="animation-duration: 1000ms;">
                            <h4 class="section-sub-title">Featured Products</h4>
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="#">
                                        <img src="{{asset('assets/images/products/small/bp1.png')}}" width="84" height="84" alt="product">
                                        <img src="{{asset('assets/images/products/small/bp1.png')}}" width="84" height="84" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="#">Ultimate 3D Bluetooth Speaker</a>
                                    </h3>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="#">
                                        <img src="{{asset('assets/images/products/small/bp5.png')}}" width="84" height="84" alt="product">
                                        <img src="{{asset('assets/images/products/small/bp5.png')}}" width="84" height="84" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="#">Brown Women Casual HandBag</a>
                                    </h3>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="#">
                                        <img src="{{asset('assets/images/products/small/bp6.png')}}" width="84" height="84" alt="product">
                                        <img src="{{asset('assets/images/products/small/bp6.png')}}" width="84" height="84" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="#">Circled Ultimate 3D Speaker</a>
                                    </h3>
                        ...
                        <div class="col-lg-3 col-sm-6 pb-5 pb-md-0 appear-animate animated fadeInLeftShorter appear-animation-visible" data-animation-name="fadeInLeftShorter" data-animation-delay="500" style="animation-duration: 1000ms;">
                            <h4 class="section-sub-title">Top Recommandés</h4>
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="#">
                                        <img src="{{asset('assets/images/products/small/bp2.png')}}" width="84" height="84" alt="product">
                                        <img src="{{asset('assets/images/products/small/bp2.png')}}" width="84" height="84" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="#">Blue Backpack for the Young -
                                            S</a> </h3>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="#">
                                        <img src="{{asset('assets/images/products/small/bp7.png')}}" width="84" height="84" alt="product">
                                        <img src="{{asset('assets/images/products/small/bp7.png')}}" width="84" height="84" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="#">Casual Spring Blue Shoes</a> </h3>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="#">
                                        <img src="{{asset('assets/images/products/small/c3.png')}}" width="84" height="84" alt="product">
                                        <img src="{{asset('assets/images/products/small/c3.png')}}" width="84" height="84" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="#">Men Black Gentle Belt</a> </h3>
                        ...
                        <div class="col-lg-3 col-sm-6 pb-5 pb-md-0 appear-animate animated fadeInLeftShorter appear-animation-visible" data-animation-name="fadeInLeftShorter" data-animation-delay="800" style="animation-duration: 1000ms;">
                            <h4 class="section-sub-title">Les plus Vendus</h4>
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="#">
                                        <img src="{{asset('assets/images/products/small/bp3.png')}}" width="84" height="84" alt="product">
                                        <img src="{{asset('assets/images/products/small/bp3.png " width="84" height="84" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="#">Brown-Black Men Casual Glasses</a>
                                    </h3>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="#">
                                        <img src="assets/images/products/small/c1.png" width="84" height="84" alt="product">
                                        <img src="assets/images/products/small/c1.png" width="84" height="84" alt="product">
                                    </a>
                                </figure>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="#">
                                        <img src="assets/images/products/small/c2.png')}}" width="84" height="84" alt="product">
                                        <img src="assets/images/products/small/c2.png')}}" width="84" height="84" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="#">Black Men Casual Glasses</a> </h3>
                        ...
                        <div class="col-lg-3 col-sm-6 pb-5 pb-md-0 appear-animate animated fadeInLeftShorter appear-animation-visible" data-animation-name="fadeInLeftShorter" data-animation-delay="1100" style="animation-duration: 1000ms;">
                            <h4 class="section-sub-title">En Soldes</h4>
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="#">
                                        <img src="assets/images/products/small/bp4.png')}}" width="84" height="84" alt="product">
                                        <img src="assets/images/products/small/bp4.png')}}" width="84" height="84" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="#">Basketball Sports Blue Shoes</a>
                                    </h3>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="#">
                                        <img src="assets/images/products/small/c4.png')}}" width="84" height="84" alt="product">
                                        <img src="assets/images/products/small/c4.png')}}" width="84" height="84" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="#">Men Sports Travel Bag</a> </h3>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="#">
                                        <img src="assets/images/products/small/c5.png')}}" width="84" height="84" alt="product">
                                        <img src="assets/images/products/small/c5.png')}}" width="84" height="84" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="#">Brown HandBag</a> </h3>
        ...
        <!-- End .main -->
        <div class="newsletter-popup mfp-hide bg-img" id="newsletter-popup-form" style="background: #f1f1f1 no-repeat center/cover url(assets/images/newsletter_popup_bg.webp)">
        <div class="newsletter-popup-content">
            ...
            <form action="#">
                <div class="input-group">
                    <input type="email" class="form-control" id="newsletter-email" name="newsletter-email" placeholder="Saisissez votre adresse e-mail*" required />
