...
<main class="main">
    ...
    <div class="container">
        <div class="categories-slider owl-carousel owl-theme show-nav-hover nav-outer">
            ...
            <div class="category category-default category-absolute appear-animate" data-animation-delay="200" data-animation-name="fadeInUpShorter">
                <a href="#">
                    <figure style="height:275px">
                        <img src="{{ asset('categories/' . $category->image) }}" alt="category" style="height:180px;width:210px;" />
                    </figure>
                ...
                <div class="product-default appear-animate mb-3" data-animation-name="fadeInRightShorter">
                    <figure>
                        <a href="{{ route('product.details', ['id' => $new_product->id]) }}">
                            <img src="{{ asset('products/' . $new_product->image) }}" width="280" height="280" alt="product">
                            <img src="{{ asset('products/' . $new_product->image) }}" width="280" height="280" alt="product">
                        </a>
                    </figure>
                    <div class="product-details">
                        <div class="category-list">
                            <a href="#" class="product-category">{{ $new_product->category->parent_category_name }}</a>
                        </div>
                        <h3 class="product-title">
                            <a href="{{ route('product.details', ['id' => $new_product->id]) }}">{{ $new_product->product_name }}</a>
                        </h3>
                        ...
                        <div class="product-action">
                            <a href="#" onclick="addWishlistItem({{ $new_product->id }})" class="btn-icon-wish" title="wishlist"><i class="icon-heart"></i></a>
                            <a href="{{ route('product.details', ['id' => $new_product->id]) }}" class="btn-icon btn-add-cart"><i class="fa fa-arrow-right"></i><span>View</span></a>
                            <a href="{{ route('product.details', ['id' => $new_product->id]) }}" class="btn-quickview" title="Quick View"><i class="fas fa-external-link-alt"></i></a>
                        </div>
                    </div>
                    <!-- End .product-details -->
                </div>
    ...
    <section class="testimonial-section testimonial-bg bg-gray">
        <div class="container">
            <div class="owl-carousel owl-theme owl-dots-simple mb-4 mb-lg-0 appear-animate owl-loaded owl-drag animated fadeInRightShorter appear-animation-visible" data-owl-options="{
                ...
                <div class="owl-nav disabled"><button type="button" title="nav" role="presentation" class="owl-prev"><i class="icon-angle-left"></i></button><button type="button" title="nav" role="presentation" class="owl-next"><i class="icon-angle-right"></i></button></div>
                <div class="owl-dots"><button role="button" title="dot" class="owl-dot active"><span></span></button><button role="button" title="dot" class="owl-dot"><span></span></button></div>
            </div>
        </div>
    </section>
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="{{ route('product.details', ['id' => $product->id]) }}">
                            <img src="{{ asset('products/' . $product->image) }}" width="84" height="84" alt="product">
                            <img src="{{ asset('products/' . $product->image) }}" width="84" height="84" alt="product">
                        </a>
                    </figure>

                    <div class="product-details">
                        <h3 class="product-title"> <a href="{{ route('product.details', ['id' => $product->id]) }}">
