    ...
    <div class="container">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Electronic gift card</a></li>
            </ol>
        </nav>

        <div class="product-single-container product-single-default">
            <div class="cart-message d-none">
                <strong class="single-cart-notice">Electronic gift card</strong>
            ...
            <div class="row">
                    ...
                    <div class="product-slider-container">
                        ...
                        <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                            <div class="product-item">
                                <img class="product-single-image" src="assets/images/products/2839a5_70a466d9bf344b1a8c5104651c208fbc~mv2.png" data-zoom-image="assets/images/products/2839a5_70a466d9bf344b1a8c5104651c208fbc~mv2.png" width="468" height="468" alt="product" />
                            </div>
                        </div>
                ...
                <div class="col-lg-7 col-md-6 product-single-details">
                    <h1 class="product-title">ELECTRONIC GIFT CARD</h1>
                    ...
                    <div class="product-desc">
                        <p>
                            ...
                            You can't go wrong with a gift card. Choose an
                            amount and add a personalized message to make this gift
                            unique.
                        </p>
                    </div>
                    ...
                    <div class="login-form-container">
                        <h4>
                            <button data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" class="btn btn-primary p-3 btn-toggle">Commander en 1 clic</button>
                        </h4>
                            ...
                            <div class="login-section feature-box">
                                <div class="feature-box-content">
                                    <form action="#" id="login-form">
                                        <h3>La livraison est à 2 000 CFA partout au Sénégal</h3>
                                        <div class="row">
