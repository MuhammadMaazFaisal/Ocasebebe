...
<main class="main">
    ...
    <div class="product-single-tabs">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="product-tab-custom" data-toggle="tab" href="#product-custom-content" role="tab" aria-controls="product-custom-content" aria-selected="false">Custom Tab</a>
            </li>
        </ul>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="product-reviews-content" role="tabpanel" aria-labelledby="product-tab-reviews">
                <div class="product-reviews-content">
                    <h3 class="reviews-title">{{ $review_count }} review for {{ $product->product_name }}</h3>

                    <div class="comment-list">
                        @foreach ($reviews as $review)
                        <div class="comments my-5">
                            <figure class="img-thumbnail mt-1">
                                <img src="{{ asset('assets/images/blog/user.png') }}" alt="author" width="60" height="60">
                            </figure>
                    ...
                    <div class="add-product-review">
                        ...
                        <form id="review-form" class="comment-form m-0">
            ...
            <div class="tab-pane fade" id="product-custom-content" role="tabpanel" aria-labelledby="product-tab-custom">
            ...
            <div class="product-default">
                ...
                <div class="product-details">
                    <div class="category-list">
                        <a href="{{ route('category', ['id' => $related_product->parent_category_id]) }}" class="product-category">{{ $category->parent_category_name }}</a>
                    </div>
                    <h3 class="product-title">
                        <a href="{{ route('product.details', ['id' => $related_product->id]) }}">{{ $related_product->product_name }}</a>
                    </h3>
                    <div class="ratings-container">
                        <div class="product-ratings">
                            <span class="ratings" style="width:{{ $related_product->avg_rating * 20 }}%"></span>
                            <!-- End .ratings -->
                            <span class="tooltiptext tooltip-top"></span>
                        </div>
                        <!-- End .product-ratings -->
                    ...
                    <!-- End .price-box -->
                    <div class="product-action">
                        <a href="#" onclick="addWishlistItem({{ $related_product->id }})" title="Wishlist" class="btn-icon-wish"><i class="icon-heart"></i></a>
                        <a href="{{ route('product.details', ['id' => $related_product->id]) }}" class="btn-icon btn-add-cart"><i class="fa fa-arrow-right"></i><span>SELECT
                                OPTIONS</span></a>
                        <a href="{{ route('product.details', ['id' => $related_product->id]) }}" class="btn-quickview"><i class="fas fa-external-link-alt"></i></a>
                    </div>
                </div>
                <!-- End .product-details -->
            </div>
