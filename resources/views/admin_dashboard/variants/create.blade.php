            ...
            <div class="card">
                <div class="card-body">
                    <div class="form theme-form">
                        <form id="" action="{{route('variants.store')}}" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" placeholder="Enter Attribute Name" data-bs-original-title="" title="" name="attribute_name" value="{{old('attribute_name')}}" >
                                    </div>
                                </div>
                            </div>
                            {{-- update work 13 --}}
