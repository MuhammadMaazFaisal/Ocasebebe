                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" placeholder="Enter Variant Name" data-bs-original-title="" title="" name="attribute_name" value="{{$variants->attribute_name}}" required>
                                        </div>
                                    </div>
                                </div>
