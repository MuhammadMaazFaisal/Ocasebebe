                ...
                <div class="product-default">
                    <figure>
                        <a href="{{ route('product.details', $product->id) }}">
                            <img src="{{ asset('products/' . $product->image) }}" width="280" style="
                    ...
                    <div class="product-details">
                        ...
                        <h3 class="product-title"> <a href="{{ route('product.details', $product->id) }}">{{ $product->product_name }}</a>
                        </h3>
        ...
        <div class="sidebar-wrapper">
            <form action="{{ route('filter') }}" method="GET">
                            ...
                            <ul class="cat-list">
                                <li>
                                    ...
                                    <div class="collapse show" id="widget-category-1">
                                        <ul class="cat-sublist">
                                            <li><input type="checkbox" id="cat_1" name="categories[]" value=1><label for="cat_1">{{ $categories_id[1] }}</label>
                                            </li>
                                            <li><input type="checkbox" id="cat_2" name="categories[]" value=2><label for="cat_2">{{ $categories_id[2] }}
                                                </label>
                                            </li>
                                            <li><input type="checkbox" id="cat_3" name="categories[]" value=3><label for="cat_3">{{ $categories_id[3] }}
                                                </label>
                                            </li>
                                            <li><input type="checkbox" id="cat_4" name="categories[]" value=4> <label for="cat_4">{{ $categories_id[4] }}</label>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="collapse" id="widget-category-2">
                                        <ul class="cat-sublist">
                                            <li><input type="checkbox" id="cat_6" name="categories[]" value=6><label for="cat_6">{{ $categories_id[6] }}</label>
                                            </li>
                                            <li><input type="checkbox" id="cat_7" name="categories[]" value=7> <label for="cat_7">{{ $categories_id[7] }}</label>
                                            </li>
                                            <li><input type="checkbox" id="cat_7" name="categories[]" value=8><label for="cat_8">{{ $categories_id[8] }}</label>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="collapse" id="widget-category-3">
                                        <ul class="cat-sublist">
                                            <li><input type="checkbox" id="cat_9" name="categories[]" value=9> <label for="cat_9">{{ $categories_id[9] }}</label>
                                            </li>
                                            <li><input type="checkbox" id="cat_10" name="categories[]" value=10> <label for="cat_10">{{ $categories_id[10] }}</label>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="collapse" id="widget-category-4">
                                        <ul class="cat-sublist">
                                            <li><input type="checkbox" id="cat_11" name="categories[]" value=11> <label for="cat_11">{{ $categories_id[11] }}</label>
                                            </li>
                                            <li><input type="checkbox" id="cat_12" name="categories[]" value=12> <label for="cat_12">{{ $categories_id[12] }}</label>
                                            </li>
                                            <li><input type="checkbox" id="cat_13" name="categories[]" value=13> <label for="cat_13">{{ $categories_id[13] }}</label>
                                            </li>
                                            <li><input type="checkbox" id="cat_14" name="categories[]" value=14> <label for="cat_14">{{ $categories_id[14] }}</label>
                                            </li>
                                            <li><input type="checkbox" id="cat_15" name="categories[]" value=15> <label for="cat_15">{{ $categories_id[15] }}</label>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="collapse" id="widget-category-5">
                                        <ul class="cat-sublist">
                                            <li><input type="checkbox" id="cat_16" name="categories[]" value=16> <label for="cat_16">{{ $categories_id[16] }}</label>
                                            </li>
                                            <li><input type="checkbox" id="cat_17" name="categories[]" value=17> <label for="cat_17">{{ $categories_id[17] }}</label>
                                            </li>
                                            <li><input type="checkbox" id="cat_18" name="categories[]" value=18> <label for="cat_18">{{ $categories_id[18] }}</label>
                                            </li>
                                            <li><input type="checkbox" id="cat_19" name="categories[]" value=19> <label for="cat_19">{{ $categories_id[19] }}</label>
                                            </li>
                                            <li><input type="checkbox" id="cat_20" name="categories[]" value=20> <label for="cat_20">{{ $categories_id[20] }}</label>
                                            </li>
                                            <li><input type="checkbox" id="cat_21" name="categories[]" value=21> <label for="cat_21">{{ $categories_id[21] }}</label>
                                            </li>
                                            <li><input type="checkbox" id="cat_22" name="categories[]" value=22> <label for="cat_22">{{ $categories_id[22] }}</label>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="collapse" id="widget-category-6">
                                        <ul class="cat-sublist">
                                            <li><input type="checkbox" id="cat_23" name="categories[]" value=23> <label for="cat_23">{{ $categories_id[23] }}
                                                </label>
                                            </li>
                                            <li><input type="checkbox" id="cat_24" name="categories[]" value=24> <label for="cat_24">{{ $categories_id[24] }}</label>
                                            </li>
                                            <li><input type="checkbox" id="cat_25" name="categories[]" value=25> <label for="cat_25">{{ $categories_id[25] }}</label>
                                            </li>
                                            <li><input type="checkbox" id="cat_26" name="categories[]" value=26> <label for="cat_26">{{ $categories_id[26] }}</label>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="collapse" id="widget-category-7">
                                        <ul class="cat-sublist">
                                            <li><input type="checkbox" id="cat_27" name="categories[]" value=27><label for="cat_27">{{ $categories_id[27] }}</label>
                                            </li>
                                            <li><input type="checkbox" id="cat_28" name="categories[]" value=28> <label for="cat_28">{{ $categories_id[28] }}</label>
                                            </li>
                                            <li><input type="checkbox" id="cat_29" name="categories[]" value=29> <label for="cat_29">{{ $categories_id[29] }}</label>
                                            </li>
                                            <li><input type="checkbox" id="cat_30" name="categories[]" value=30><label for="cat_30">{{ $categories_id[30] }}</label>
                                            </li>
                                            <li><input type="checkbox" id="cat_31" name="categories[]" value=31><label for="cat_31">{{ $categories_id[31] }}</label>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="single-li"><input type="checkbox" id="cat_32" name="categories[]" value=32><label for="cat_32">{{ $categories_id[32] }}</label>
                                </li>
                            </ul>
                        </div>
                        <!-- End .widget-body -->
                ...
                <div class="widget widget-size">
                    ...
                    <div class="widget-body pb-0">
                        <ul class="config-size-list">
                            ...
                            <li class="size-btn1 mx-2" data-id="{{ $length->id }}">
                                <input type="checkbox" name="sizes[]" value="{{ $length->id }}" id="size-{{ $length->id }}" style="display:none;">
                                <label for="size-{{ $length->id }}" style="padding:1px 4px 1px 4px">{{ $length->name }}</label>
                            </li>
                            @endforeach
                        </ul>
                    </div>
                ...
                <div class="widget widget-size">
                    ...
                    <div class="widget-body pb-0">
                        <ul class="config-size-list">
                            <li class="size-btn1 mx-2">
                                <input type="checkbox" name="gender[]" value="Male" id="m-gender" style="display:none;">
                                <label for="m-gender" style="padding:1px 4px 1px 4px">Male</label>
                            </li>
                            <li class="size-btn1 mx-2">
                                <input type="checkbox" name="gender[]" value="Female" id="f-gender" style="display:none;">
                                <label for="f-gender" style="padding:1px 4px 1px 4px">Female</label>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="owl-carousel widget-featured-products">
                        <div class="featured-col">
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="{{ route('product.details', $product->id) }}">
                                        <img src="{{ asset('products/' . $product->image) }}" style="
